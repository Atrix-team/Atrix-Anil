...
import logo from "../assets/apatrix-main-logo.svg";
...
const Footer = () => {
    return (
        <footer className="bg-cs_theme_black">
            <div className=" max-w-[90%] mx-auto text-white flex flex-wrap md:pt-28 pt-14 md:pb-24 pb-10 ">
                <div className=" md:w-1/4 md:pr-16 ">
                    <div className=" h-14 w-auto md:m-0  flex ">

                        <img src={logo} alt="" />
                    </div>
                    <h4 className=" text-cs_blue mt-5 font-bold text-lg">Address</h4>
                    <p className="  uppercase" > PLOT C – 203 , PHASE – 8 B, MOHALI, MOHALI, SAS Nagar , 26-Punjab, 91-INDIA, 160070</p>


                    <h4 className="  text-cs_blue mt-5 font-bold text-lg">Email</h4>
                    <p>info@apatrixitsolutions.com</p>

                    <h4 className=" text-cs_blue mt-5 font-bold text-lg  ">Social Just You Connected Us!</h4>
                    <ul className=" flex gap-3 mt-3 md:justify-start  ">
                        <li className="w-8 h-8 border border-cs_white flex justify-center items-center rounded-full cursor-pointer ">
                            <FaFacebookF />
                        </li>
                        <li className="w-8 h-8 border border-cs_white flex justify-center items-center rounded-full cursor-pointer ">
                            <FaXTwitter />
                ...
                <div className="md:w-3/4 flex flex-wrap ">
                    <div className="w-full md:w-3/6 uppercase ">
                        ...
                        <ul className="mt-5 text-sm columns-2 gap-4 space-y-4">
                    ...
                    <div className="md:w-2/4 flex flex-col md:flex-row ">
                        ...
                        <div className="mt-10 md:mt-0 w-full md:w-2/3  ">
